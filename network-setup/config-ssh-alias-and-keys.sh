...
updateSshdConfig() {
	...
	read -rp "${sLaunchDir}"
	suExecCommand "	rsync -av \"$(readlink ${sLaunchDir}/../src/etc/ssh/sshd_config.d/)\" /etc/ssh/sshd_config.d/; \
					rsync -av \"$(readlink ${sLaunchDir}/../src/etc/ssh/ssh_config.d/)\" /etc/ssh/ssh_config.d/"
